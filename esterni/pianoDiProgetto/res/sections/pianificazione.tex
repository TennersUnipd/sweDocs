...
\begin{itemize}
	\item \textbf{\RomanNumeralCaps{1} Incremento:} (entro il 19.02.2020);
	\item \textbf{\RomanNumeralCaps{2} Incremento:} (entro il 25.02.2020);
	\item \textbf{\RomanNumeralCaps{3} Incremento:} (entro il 28.02.2020);
	\item \textbf{\RomanNumeralCaps{4} Incremento:} (entro il 05.03.2020);
	\item \textbf{\RomanNumeralCaps{5} Incremento:} (entro il 9.03.2020);
	\item \textbf{\RomanNumeralCaps{6} Incremento:} (entro il 16.03.2020).
\end{itemize}
...
\subsubsection{Incrementi previsti}
\begin{itemize}
	\item \textbf{\RomanNumeralCaps{1} Incremento:} (entro il 29.04.2020);
	\item \textbf{\RomanNumeralCaps{2} Incremento:} (entro il 04.05.2020);
	\item \textbf{\RomanNumeralCaps{3} Incremento:} (entro il 07.05.2020);
	\item \textbf{\RomanNumeralCaps{4} Incremento:} (entro il 09.05.2020);
	\item \textbf{\RomanNumeralCaps{5} Incremento:} (entro il 11.05.2020);
	\item \textbf{\RomanNumeralCaps{6} Incremento:} (entro il 28.05.2020).
\end{itemize}
