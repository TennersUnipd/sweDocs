\section{Verbale della riunione}
	...
	\begin{itemize}
		...
		\item \textbf {La gestione degli unit test per l'applicazione in Ethereum\glos}:
		...
		\item \textbf{Manuale utente:} insieme al proponente è stato concordata la stesura di un breve manuale utente redatto in lingua inglese per illustrare il funzionamento dell'applicativo.
	\end{itemize}
