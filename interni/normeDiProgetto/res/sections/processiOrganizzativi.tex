		...
		\subsubsection{Scopo}
  		...
  		\subsubsection{Aspettative}
   		...
   		\subsubsection{Ruoli di progetto}
   			...
   			Il Responsabile è il punto di riferimento sia per il fornitore che per il committente. Inoltre è colui che raccoglie su di sé le responsabilità decisionali di scelta e approvazione e costituisce il centro di coordinamento per l'intero progetto.
   		...
   		\subsubsection{Procedure}
			  ...
			  .2 Etherless-Cli.
				...
				Il repository Etherless contiene tutto il progetto in tutte le sue componenti
   			...
   			\paragraph{Gestione degli strumenti di coordinamento}
   				\subparagraph{Tickecting}
   					...
   					Come strumento di tickecting e' stato deciso di usare i servizi di project board offerti da GitHub.
   					...
   					Le varie attività vengono riportate come milestone per il reposity di riferimento, e vengono analizzati e suddivisi in issues. Questo permette di inserire i vari requisiti usando un approccio top-down, e di usare un metodo bottom-up per soddisfarli.
