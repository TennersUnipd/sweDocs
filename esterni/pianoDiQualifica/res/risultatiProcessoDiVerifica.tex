...
\begin{center}
	\begin{tikzpicture} [scale = 0.9]
		\begin{axis}[
			...
			\draw[line width=0.1](2020-03-26,50)--(2020-04-06,50);
		\end{axis}
	\end{tikzpicture} \\
\end{center}
...
\begin{center}
	...
	\draw [line width=0.1](2020-1-9, 60)--(2020-4-10, 60);
	\end{axis}
	\end{tikzpicture} \\
\end{center}
...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \draw [line width=0.1](2020-1-9, 60)--(2020-2-18, 60);
  \end{axis}
\end{tikzpicture} \\
...
\begin{center}
	\begin{tikzpicture} [scale = 0.8]
		\begin{axis}[
			...
			\draw[line width=0.1](2020-4-4,70)--(2020-4-10,70);
		\end{axis}
	\end{tikzpicture} \\
\end{center}
...
\begin{center}
	\begin{tikzpicture} [scale = 0.8]
		\begin{axis}[
			...
			\addlegendentry{$min$}
			\draw[line width=0.1](2020-3-29,10)--(2020-4-10,10);
		\end{axis}
	\end{tikzpicture} \\
\end{center}
...
\begin{center}
	\begin{tikzpicture} [scale = 0.8]
		\begin{axis}[
			...
			\draw[line width=0.1](2020-3-29,20)--(2020-4-10,20);
		\end{axis}
	\end{tikzpicture} \\
\end{center}
\subsubsection{Valutazioni}
