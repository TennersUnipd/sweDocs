\subsubsection{Linguaggi e Strumenti}
\paragraph{Linguaggi}
...
\begin{itemize}
	...
	stato scritto, ed inserito in un \textit{Docker container\glo} apposito, uno script per il controllo degli gli errori di digitazione;
