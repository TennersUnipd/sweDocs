...
\paragraph{Procedure per la gestione dei repository e del flusso di lavoro}
	...
	\begin{itemize}
		\item \textbf{Avvio di una nuova attività: } all’inizio di una nuova attività ogni componente del gruppo deve creare un nuovo feature \textit{branch\glos}, partire dal ramo denominato "develop";
