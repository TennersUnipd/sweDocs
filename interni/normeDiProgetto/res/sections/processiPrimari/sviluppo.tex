...
\begin{itemize}
  ...
  \item \textbf{Product Baseline}: viene presentata una Baseline architetturale coerente con quanto mostrato in Technology Baseline, tramite l'utilizzo di diagrammi delle classi e di sequenza. L'analisi è comprensiva di design pattern contestualizzati all'architettura.
\end{itemize}
