...
\begin{itemize}
  ...
  \end{itemize}
	...
	\begin{itemize}
		...
		\item find: viene aggiunto al comando "find", la possibilità di visualizzare l'autore e la descrizione delle funzione. Sono legati ai casi d'uso UC9.2.1 e UC9.2.3;
	\end{itemize}
