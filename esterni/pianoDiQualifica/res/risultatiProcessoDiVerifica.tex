...
\paragraph{RQ}
I risultati sono in linea con lo sviluppo del software. Il team si aspettava questo valore ed è fiducioso di raggiungere il valore ottimale alla prossima revisione.
...
\subsubsection{Valutazioni}
\paragraph{RQ}
I valori ottenuti sono in linea con quelli desiderabili, alcuni sono molto alti, ma in linea con l'architettura e quindi immutabili.
...
\paragraph{RQ}
Le misurazioni hanno avuto tutto sommato un esito positivo. I documenti che non sono stati modificati hanno mantenuto il loro valore. Il \textit{Piano di Qualifica\doc} ha ottenuto un indice più alto, forse a causa dell'aggiunta di parti meno discorsive che hanno alzato il numero di frasi conteggiate. Alcuni documenti hanno avuto un lieve peggioramento nell'indice associato ma entro la consegna ci impegnamo a migliorarlo.
...
\subsubsection{Valutazioni}
\paragraph{RQ}
Il valore di una componente è molto alto a causa di cicli annidati, sicuramente non accettabile. Il team è stato avvisato e alla prossima revisione prenderà provvedimenti.\\
\noindent Il valore medio e molto buono segno che in generale il codice è di buona qualità.
...
\subsubsection{Valutazioni}
\paragraph{RQ}
I commenti sono state una priorità importante durante lo sviluppo e grazie a questo il nostro codice risulta leggibile e ha un valore molto alto.
