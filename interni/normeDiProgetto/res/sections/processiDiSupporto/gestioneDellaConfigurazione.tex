...
%  In caso di versione approvata, il TAG viene rimosso.
 ...
 Viene riallineato a ogni rilascio del prodotto intero, ad esempio dopo un incremento, selezionando il numero di versione maggiore da uno dei sottoprodotti.
 In questo modo si raggiunge una consistenza generale sulla versione attuale ad alto livello e un sistema di versionamento più elastico
 in prospettiva di aderire meglio al modello incrementale.
