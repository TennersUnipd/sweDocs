...
Si sono presi in esame i requisiti descritti nell'\textit{Analisi dei Requisiti\docs} e calcolato la percentuale di quelli soddisfatti attualmente dall'architettura, tramite la formula descritta nelle \textit{Norme di Progetto 3.0.0\docs}.\\
...
\begin{center}
	\begin{tikzpicture} [scale = 0.9]
		\begin{axis}[
			...
			\draw[line width=0.1, green](2020-03-26,50)--(2020-5-8,50);
		\end{axis}
	\end{tikzpicture} \\
\end{center}
...
\paragraph{RA}
Entrambi gli indici hanno superato il valore desiderbile. Con questo ci avviamo al
completamento del software e ci aspettiamo di soddisfare tutti i requisiti alla consegna. I risultati rispecchiano la soddisfazione del proponente durante le riunioni.
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Analisi dei requisiti & 57  & 62 & 61 & 61 & Superato Ott. \\
\end{longtable}
\begin{center}
	\begin{tikzpicture} [scale = 0.9]
	\begin{axis}[
	...
	\draw [line width=0.1, green](2020-1-9, 60)--(2020-5-8, 60);
	\end{axis}
	\end{tikzpicture} \\
\end{center}
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Piano di Progetto & 68  & 70 & 68 & 67 & Superato Ott. \\
\end{longtable}
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Piano di qualifica & 57 & 66 & 76 & 68 & Superato Ott. \\
\end{longtable}
\begin{tikzpicture}
  \begin{axis}[
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Norme di progetto & 64  & 70 & 76 & 76 & Superato Ott. \\
\end{longtable}
\begin{tikzpicture}
  \begin{axis}[
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Studio di fattibilità & 60  & 62 & 62 & 62 & Superato Ott. \\
\end{longtable}
\begin{tikzpicture}
  \begin{axis}[
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Glossario & 48  & 48 & 48 & 48 & Superato \\
\end{longtable}
\begin{tikzpicture}
  \begin{axis}[
...
\paragraph{RA}
I documenti risultano in buono stato. In generale si registra qualche inflessione negativa, dato che rispecchia la correzione di alcune parti, con parti più discorsive che abbassano il valore. In conclusione i documenti sono pronti per la consegna finale e le correzioni sono state applicate in modo tempestivo.

\subsection{Verifica}

\begin{longtable}{|C{2.5cm}|C{2cm}|C{2cm}|C{2cm}|C{2cm}|C{2cm}|}
	\arrayrulecolor{white}

	\caption{Tabella dei valori per la percentuale dei test soddisfatti}\\
	\hline
	\rowcolor{header}
	...
	Percentuale test soddisfatti	&	- & - & 72 & 97 & Superato Ott.\\
	\hline
	\end{longtable}
\subsubsection{Percentuale test soddisfatti}
\begin{center}
	\begin{tikzpicture} [scale = 0.8]
	\begin{axis}[
		title={Grafico per Percentuale test soddisfatti},
		legend pos=outer north east,
		xlabel={\textbf{Tempo}},
		ylabel={\textbf{Valore}},
		date coordinates in=x,
		...
		\addplot table [col sep=comma,x=date,y=value,blue] {res/MisurazioniCSV/percentualeTest.csv};
		\draw[line width=0.1, green](2020-4-23,70)--(2020-5-9,70);
		\end{axis}
	\end{tikzpicture} \\
\end{center}
\subsubsection{Valutazioni}
\paragraph{RA}
Il gruppo ha implementato un gran numero di test di unità e di integrazione e con un'alta percentuale rispetto a quella prefissata.
...
\begin{longtable}{|C{2.5cm}|C{2cm}|C{2cm}|C{2cm}|C{2cm}|C{2cm}|}
	...
	\caption{Tabella dei valori per la code coverage}\\
	\hline
	\rowcolor{header}

	\textbf{Metrica} & \textbf{RR} & \textbf{RP} & \textbf{RQ} & \textbf{RA} & \textbf{Esiti}
	\tabularnewline
	\endfirsthead

	Code Coverage    &    - & - & 72 & 73 &Superato Ott.\
\end{longtable}
\begin{center}
	\begin{tikzpicture} [scale = 0.8]
		\begin{axis}[
			...
			\draw[line width=0.1, green](2020-4-4,70)--(2020-5-8,70);
		\end{axis}
	\end{tikzpicture} \\
\end{center}
\subsubsection{Valutazioni}
...
\paragraph{RA}
Nonostante gli ultimi fix e l'aggiunta di nuove funzionalità etherless-cli non ha
registrato nessun calo nel valore di code coverage, grazie all'implementazione di test
contestuale all'implementazione. Avere dei test validi e automatici su tutto il codice è stato di grande aiuto, soprattutto nel gestire l'integrazione continua del software.
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Actual Cost (AC) & -  & \euro4.207,00 & \euro6.902,00 & \euro2.498,00 & Superato Ott.
\end{longtable}
\begin{center}
\begin{tikzpicture} [scale = 0.9]
	\begin{axis}[
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Earned Value (EV) & -  & \euro4.536,84 & \euro 9.073,68& \euro13.748,00& Superato Ott.
\end{longtable}
\begin{center}
	\begin{tikzpicture}
	\begin{axis}[
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Estimated at Completion (EAC) & -  & \euro13.418,16 & \euro11.576,32 & \euro2.498,00 & Superato
\end{longtable}
\begin{center}
	\begin{tikzpicture}
	\begin{axis}[
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Estimated To Complete (ETC) & -  & \euro9.211,16 & \euro4.674,32 & \euro 0 & Superato
\end{longtable}
\begin{center}
	\begin{tikzpicture}
	\begin{axis}[
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Cost Variance (CV) & -  & \euro329,00 & \euro 2.171,68 & \euro11.250,00 & Superato
\end{longtable}
\begin{center}
	\begin{tikzpicture}
	\begin{axis}[
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Schedule Variance (SV) & -  & \euro252,84 & \euro2.107,68 & \euro11.250,00 & Superato
\end{longtable}
\begin{center}
	\begin{tikzpicture}
	\begin{axis}[
...
\paragraph{RA}
Il progetto è stato concluso all'interno dei tempi prefissati, secondo le stime previste iniziali. Le misurazioni relative alla pianificazione hanno dimostrato che il progetto ha avuto, in data di consegna, un guadagno in termini di impiego di risorse.


\subsection{Funzionalità}
\subsubsection{Copertura Funzionale}
Di seguito i risultati delle misurazioni della copertura funzionale.
\renewcommand{\arraystretch}{2.2}
\rowcolors{2}{pari}{dispari}
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	\arrayrulecolor{white}

	\caption{Tabella dei valori per la copertura funzionale}\\
	\hline
	\rowcolor{header}
	...
	\tabularnewline
	\endfirsthead
	Copertura funzionale & -  & - & 46,38 & 95,71 & Superato Ott.
\end{longtable}
\begin{center}
	\begin{tikzpicture} [scale = 0.8]
		\begin{axis}[
			...
			\addplot table [col sep=comma,x=date,y=value,blue] {res/MisurazioniCSV/funcoverage.csv};
			\draw[line width=0.1,green](2020-3-26,90)--(2020-5-8,90);
		\end{axis}
	\end{tikzpicture} \\
\end{center}
...
\subsubsection{Valutazioni}
\paragraph{RQ}
La copertura funzionale deve ancora raggiungere il valore ottimale. Ora che il team è riuscito a definire un'architettura, contiamo di completare le funzionalità sia quelle obbligatorie richieste dal capitolato, che quelle desiderabili.

\paragraph{RA}
Con l'avvicinarsi della consegna siamo riusciti a completare buona parte delle funzionalità. Il team ritiene che raggiungere il valore massimo sia impossibile, dato che si tratta di raffinamenti o funzionalità opzionali irraggiungibili con le nostre competenze e i nostri strumenti.
...
\begin{longtable}{|C{4.5cm}|C{3cm}|C{3cm}|C{3cm}|}
	...
	\caption{Tabella dei valori per la complessità ciclomatica}\\
	\hline
	\rowcolor{header}
	...
	Complessità ciclomatica	&	0 & 12 & 6 \\
	\hline
\end{longtable}
...
\begin{center}
	\begin{tikzpicture} [scale = 0.8]
		\begin{axis}[
			...
			\addlegendentry{$min$}
			\draw[line width=0.1, green](2020-3-29,10)--(2020-5-8,10);
		\end{axis}
	\end{tikzpicture} \\
\end{center}
...
Di seguito i risultati delle misurazioni della percentuale di commenti nel codice.
\renewcommand{\arraystretch}{2.2}
\rowcolors{2}{pari}{dispari}
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	\arrayrulecolor{white}

	\caption{Tabella dei valori per la percentuale di commenti}\\
	\hline
	\rowcolor{header}
	...
	Percentuale commenti & -  & - & 35 & 34 & Superato Ott.
\end{longtable}
...
\begin{center}
	\begin{tikzpicture} [scale = 0.8]
		\begin{axis}[
			...
			\draw[line width=0.1, green](2020-3-29,20)--(2020-5-14,20);
		\end{axis}
	\end{tikzpicture} \\
\end{center}
...
\paragraph{RA}
\begin{itemize}
	\item Dopo la Revisione di qualifica il team si è dedicato al miglioramento del codice, lavorando anche sull'indice di complessità ciclomatica. Il valore massimo è sensibilmente diminuito rimanendo comunque sopra la soglia accettabile. Il gruppo è consapevole che si può migliorare da questo punto di vista. Per quanto riguarda la media tra le componenti il valore rimane sotto controllo e sicuramente accettabile, segno di un codice in generale leggibile e riutilizzabile.
	\item Il valore in percentuale dei commenti, all'inizio del periodo, sensibilmente diminuito a causa dell'aumento delle linee del codice. Il team ha notato che con l'aumento delle funzionalità queste ultime sono aumentate e non si è riusciti inizialmente a tenere il passo con i commenti. Nell'ultima parte del progetto, il team ha focalizzato le sue attenzioni su questo aspetto ed è riuscito a riportare il valore ad una percentuale buona. In conclusione la percentuale di commenti rimane soddisfacente e ben al di sopra del valore desiderabile.
\end{itemize}
