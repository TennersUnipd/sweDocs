...
\begin{itemize}
  \item \textbf{\RomanNumeralCaps{1} Incremento:} (entro il 19.02.2020) Correzione e integrazione documenti in base alle conoscenze acquisite durante l'\texit{Analisi dei requisiti}\docs;
...
\begin{itemize}
  ...
  \begin{itemize}
    \item \texit{Norme di Progetto}\docs;
    \item \texit{Analisi dei requisiti}\docs;
    \item \texit{Piano di qualifica}\docs;
    \item \texit{Piano di progetto}\docs;
    \item \texit{Glossario}\docs.
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item Valutazione dei rischi nel consuntivo di periodo del \texit{Piano di progetto}\docs.
  \end{itemize}
