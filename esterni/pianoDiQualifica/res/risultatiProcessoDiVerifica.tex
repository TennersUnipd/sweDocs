...
\paragraph{RA}
I documenti risultano in buono stato. In generale si registra qualche inflessione negativa, dato che rispecchia la correzione di alcune parti, con parti più discorsive che abbaso il valore. In conclusione i documenti sono pronti per la consegna finale e le correzioni sono state applicate in modo tempestivo.
...
contestuale all'implementazione. Avere dei test validi e automatici su tutto il codice c'è stato di grande aiuto, soprattutto nel gestire l'integrazione continua del software.
Su alcune componenti si può sicuramente migliorare, ma per i nostri mezzi è il massimo che siamo riusciti a ottenere.
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Estimated To Complete (ETC) & -  & \euro9.211,16 & \euro4.674,32 & \euro 0 & Superato Ott.
\end{longtable}
\begin{center}
	\begin{tikzpicture}
	\begin{axis}[
...
\begin{center}
	\begin{tikzpicture} [scale = 0.8]
		\begin{axis}[
			...
			\draw[line width=0.1, green](2020-3-29,20)--(2020-5-8,20);
		\end{axis}
	\end{tikzpicture} \\
\end{center}
...
\begin{itemize}
	...
	\item Il valore in percentuale dei commenti è sensibilmente diminuito a causa dell'aumento delle linee del codice. Il team ha notato che con l'aumento delle funzionalità queste ultime sono aumentate sensibilmente e non si è riusciti a tenere il passo con i commenti. In conclusione il valore rimane comunque soddisfacente e al di sopra del valore desiderbile.
\end{itemize}
