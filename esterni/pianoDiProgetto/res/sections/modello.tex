...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \textit{Glossario}\docs.
  \end{itemize}
	\item \textbf{\RomanNumeralCaps{2} Incremento:} implementazione dell'ultima versione del prodotto:
	\begin{itemize}
		\item inserimento degli ultimi comandi opzionali che non sono stati inseriti durante la progettazione di dettaglio e codifica;
	\end{itemize}
	\item \textbf{\RomanNumeralCaps{3} Incremento:} implementazione dei test di sistema e successiva codifica delle correzioni;
	\item \textbf{\RomanNumeralCaps{4} Incremento:} redazione della documentazione relativa al codice;
	\item \textbf{\RomanNumeralCaps{5} Incremento:} realizzazione dei test di accettazione;
	\item \textbf{\RomanNumeralCaps{6} Incremento:} aggiornamento dei documenti da presentare in ingresso alla revisione di accettazione;
	\item \textbf{\RomanNumeralCaps{7} Incremento:} presentazione RA.
\end{itemize}
