...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Analisi dei requisiti & 57  & 62 & 61 & 61 & Superato \\
\end{longtable}
\begin{center}
	\begin{tikzpicture} [scale = 0.9]
	\begin{axis}[
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Piano di Progetto & 68  & 70 & 68 & 67 & Superato \\
\end{longtable}
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Piano di qualifica & 57 & 66 & 76 & 68 & Superato \\
\end{longtable}
\begin{tikzpicture}
  \begin{axis}[
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Norme di progetto & 64  & 70 & 76 & 76 & Superato \\
\end{longtable}
\begin{tikzpicture}
  \begin{axis}[
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Studio di fattibilità & 60  & 62 & 62 & 62 & Superato \\
\end{longtable}
\begin{tikzpicture}
  \begin{axis}[
...
\begin{longtable}{|C{4.5cm}|C{2cm}|C{2cm}|C{2cm}|C{2cm}|}
	\arrayrulecolor{white}
	...
	\textbf{Metrica} & \textbf{RR} & \textbf{RP} & \textbf{RQ} & \textbf{RA}
	\tabularnewline
	\endfirsthead
	
	Percentuale test soddisfatti	&	- & - & 72 & 97\\
	\hline
	\end{longtable}
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	\tabularnewline
	\endfirsthead
	Copertura funzionale & -  & - & 46,38 & 95,71 & Superato
\end{longtable}
\begin{center}
	\begin{tikzpicture} [scale = 0.8]
		\begin{axis}[
...
\begin{longtable}{|C{4.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|C{1.5cm}|}
	...
	Percentuale commenti & -  & - & 35 & 34 & Superato
\end{longtable}
