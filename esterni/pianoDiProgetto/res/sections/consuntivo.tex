...
In seguito è rappresentato il consuntivo del periodo di progettazione in dettaglio e codifica:
\begin{table}[h]
	\caption{Tabella consuntivo di periodo, progettazione in dettaglio e codifica}  
	\begin{center}
		\begin{tabular}{ |c|c|c|  }
			\hline
			Ruolo 		& Ore & Costo (EUR)\\
...
\begin{table}[h]
	\caption{Tabella ore e costo totale previsti per incremento, progettazione in dettaglio e codifica}
	\begin{center}
