...
\paragraph{Gestione dei repository e del flusso di lavoro}
	...
	\begin{enumerate}
		...
		\end{itemize} 
		\item \textbf{Approvazione e rilascio:} Alla ricezione di una \textit{pull request\glo} dal \textit{branch\glo} "develop" il responsabile deciderà se approvare o meno le modifiche. In caso di accettazione il responsabile dovrà rimuovere ogni TAG "TBA".
	\end{enumerate}
